;(function($) {
	...
	var def_tinymce_option_base = {
		...
		toolbar: "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | forecolor backcolor | bullist numlist outdent indent | link | fontselect fontsizeselect"
	};
